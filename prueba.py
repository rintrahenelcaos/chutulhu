...
from constants import WIDTH, HEIGHT,FACTION_DECK_POSITION, FACTION_HAND, SPELL_DECK_POSITION, SPELLS_HAND, BOARD, BACKGROUND_COLOR, ENEMY_FACTION_HAND, ENEMY_SPELLS_HAND, ROWS, COLUMNS ,CELL, GENERIC_FONT, faction_deck_drawer_button, spells_deck_drawer_button
pygame.init()
...
while run:
    ...
    faction_deck_scaled_image = pygame.transform.scale(faction_deck_scaled_image, (faction_deck_drawer_button.width, faction_deck_drawer_button.height))
